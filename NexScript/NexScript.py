...
class Lexer:
  ...
  def advance(self):
    if self.pos.idx + 1 < len(self.text):
        current_char = self.text[self.pos.idx + 1]
...
class Parser:
  ...
  def update_current_tok(self):
    if self.tok_idx < 0 or self.tok_idx >= len(self.tokens):
        self.current_tok = Token(TT_EOF, pos_start=None, pos_end=None)
    else:
...
global_symbol_table.set("INPUT-FLOAT", BuiltInFunction.print_ret)
...
global_symbol_table.set("IS-FUNC", BuiltInFunction.is_function)
